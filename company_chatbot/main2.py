...
app.mount("/css", StaticFiles(directory="company_chatbot/css"), name="css")
app.mount("/js", StaticFiles(directory="company_chatbot/js"), name="js")
app.mount("/images", StaticFiles(directory="company_chatbot/images"), name="images")
app.mount("/fonts", StaticFiles(directory="company_chatbot/fonts"), name="images")
...
if __name__ == "__main__":
    uvicorn.run(app, host="0.0.0.0", port=6441)